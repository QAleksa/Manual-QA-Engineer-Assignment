...
WebUI.verifyElementPresent(findTestObject('Checkout_Page/li_OrderConfirmationMessage'), 0)

WebUI.verifyElementText(findTestObject('Checkout_Page/li_OrderConfirmationMessage'), GlobalVariable.orderConfirmationMsg)
