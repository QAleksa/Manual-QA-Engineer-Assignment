...
WebUI.setText(findTestObject('Checkout_Page/input_CardNumber'), GlobalVariable.invalidCardNumber)

WebUI.setText(findTestObject('Checkout_Page/input_ExpiryDate'), GlobalVariable.invalidExpiryDate)

WebUI.click(findTestObject('Checkout_Page/button_Continue'))

WebUI.comment('Test case is passing because there is no field validation for card information, however after continuing the flow error 500 will be displayed.')
