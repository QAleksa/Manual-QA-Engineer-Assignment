...
WebUI.setText(findTestObject('SignIn_Page/input_Username'), GlobalVariable.invalidUsername)
...
WebUI.verifyElementPresent(findTestObject('SignIn_Page/errorMsg_LoginFailed'), 0)

WebUI.verifyElementText(findTestObject('SignIn_Page/errorMsg_LoginFailed'), GlobalVariable.loginFailedMsg)
