...
WebUI.verifyElementPresent(findTestObject('Navigation_bar/img_Petstore'), 0)

WebUI.verifyElementPresent(findTestObject('Navigation_bar/button_Cart'), 0)

WebUI.verifyElementPresent(findTestObject('Navigation_bar/button_Help'), 0)

WebUI.verifyElementPresent(findTestObject('Navigation_bar/input__Search'), 0)
...
WebUI.selectOptionByIndex(findTestObject('Register_Page/select_Language'), 0)

WebUI.selectOptionByIndex(findTestObject('Register_Page/select_Category'), 1)

WebUI.check(findTestObject('Register_Page/checkbox_MyList'))

WebUI.check(findTestObject('Register_Page/checkbox_MyBanner'))
...
WebUI.verifyElementNotPresent(findTestObject('Register_Page/input_UserID'), 3)
